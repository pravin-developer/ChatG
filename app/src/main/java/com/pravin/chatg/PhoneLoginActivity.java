...
public class PhoneLoginActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputVerificationCode=(EditText)findViewById(R.id.verification_input);
        ...
        SendVerificationButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(PhoneLoginActivity.this,"please enter your phone number wih country code (+91)",Toast.LENGTH_SHORT).show();
                }
                else {
        ...
        callbacks=new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            {
                loadingBar.dismiss();
                Toast.makeText(PhoneLoginActivity.this,"please enter a valid number",Toast.LENGTH_SHORT).show();
